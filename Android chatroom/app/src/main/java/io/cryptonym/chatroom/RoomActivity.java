...
import io.cryptonym.adapter.PopuwindowAdapter;
import io.cryptonym.adapter.UsesAdapter;
import io.agora.chatroom.R;
import io.agora.rtc.Constants;
import io.agora.rtc.IRtcEngineEventHandler;
import io.agora.rtc.RtcEngine;
import io.cryptonym.utils.Constant;
import io.cryptonym.utils.SoundEffectUtil;
        ...
        public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
            switch (buttonView.getId()) {
                ...
                case R.id.room_audio_mixing:
                    // 播放伴奏音乐
                    if (isChecked) {
                        mRtcEngine.startAudioMixing("/assets/doudizhu.mp3", false, false, 1);
                        // 调整伴奏音量，防止伴奏声音过大影响人声
